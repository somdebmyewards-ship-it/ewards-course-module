                    ...
                    <>
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          const key = `cert-dl-${idx}`;
                          try {
                            message.loading({ content: 'Preparing certificate…', key, duration: 0 });
                            ...
                            message.success({ content: 'Certificate downloaded!', key, duration: 3 });
                          } catch (e: any) {
                            console.error('Certificate download error:', e);
                            const reason = e?.serverMessage || e?.message || 'Unknown error';
                            message.error({ content: 'Failed to download certificate: ' + reason, key, duration: 6 });
                          }
                        }}
                      >
                        Download
