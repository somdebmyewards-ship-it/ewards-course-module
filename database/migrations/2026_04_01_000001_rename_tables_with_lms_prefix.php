...
return new class extends Migration
{
    private array $renames = [
        ...
        'outlets'                => 'lms_outlets',
        'users'                  => 'lms_users',
        'training_modules'       => 'lms_modules',
        'training_sections'      => 'lms_sections',
        'training_checklists'    => 'lms_checklists',
        'training_quizzes'       => 'lms_quizzes',
        'training_progress'      => 'lms_progress',
        ...
        'module_ai_settings'     => 'lms_ai_settings',
        'module_ai_documents'    => 'lms_ai_documents',
        'module_ai_chunks'       => 'lms_ai_chunks',
        'module_ai_chat_logs'    => 'lms_ai_chat_logs',
