...
- Name: 04-admin.spec.ts >> Pending Approvals >> sidebar shows Pending Approvals link for admin
- Location: tests/e2e/04-admin.spec.ts:71:3
...
Call log:
  - navigating to "http://127.0.0.1:8001/pending-approvals", waiting until "load"
